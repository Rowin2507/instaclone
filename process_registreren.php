  ...
  <div class="login">
    ...
    <?php
      ...
      if (!isset($_POST['submit'])) {
        ...
        echo '<a style="color: #f77737;" href="registreren.php">Klik hier om een account aan te maken.</a>';
        exit();
      }
     ...
     if($checkrows>0) {
        echo 'Een account met gebruikersnaam <strong>'. $username . '</strong> bestaat al.
              <p><a style="color: #f77737;" href="registreren.php">Klik hier om een ander account aan te maken</a>';
        exit();
     } else {
      ...
      $msg = '
        ...
        <body style="margin: 0 auto; font-family: sans-serif; background: #E6E6E6; color: #000; text-align: center;">
          <table class="logo" cellspacing="0" style="background: #fff; width: 600px; padding: 25px; border-radius: 8px;">
            <tr><a href="http://23250.hosts.ma-cloud.nl/instaclone/"><img style="width: 50%;" src="http://23250.hosts.ma-cloud.nl/instaclone/instaclone-mail.png" /></a></td>
            </tr>
          </table>
          ...
          <table class="content" cellspacing="0" style="background: #fff; width: 600px; height: 750px; padding: 25px; border-radius: 8px;">
            <tr>
              ...
              <a href="http://23250.hosts.ma-cloud.nl/instaclone/verify_registreren.php?mailadres=' . $mailadres . '&hashcode=' . $hashcode . '">Klik hier om je e-mail te bevestigen</a>
            </tr>
            <tr>
              <p>2017 © InstaClone | <a href="http://23250.hosts.ma-cloud.nl/">Rowin Schmidt</a> | MediaCollege
            </tr>
          </table>
