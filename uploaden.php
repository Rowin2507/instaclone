...
<head>
    ...
    <title>Uploaden | InstaClone</title>
  ...
  <div class="uploaden" id="uploaden">
    ...
    <p><img src="uploadImage.png" id="preview" alt="PreviewImage" />
      <p><form enctype="multipart/form-data" method="post" action="#" id="upload-form">
          ...
          <label for="description">Beschrijving:</label></p>
          <textarea name="description" id="description" placeholder="Beschrijving (Max. 140 tekens)" required></textarea>
